          ...
          <div className="navbar-start">
            <div className="dropdown">
              ...
              >
                ...
                <li>
                  <a href="/links/news">Create links</a>
                </li>
              ...
              ? (
                <div className="space-y-4">
                  ...
                  <div className="space-x-4">
                    <a href="/links/new" className="btn btn-primary">Create New Link</a>
                    <a href="/oauth/signout" className="btn btn-outline btn-error">Sign Out</a>
                  </div>
                </div>
              )
